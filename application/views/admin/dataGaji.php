...
<div class="container-fluid">
    ...
    <?php } else { ?>
        <span class="badge badge-danger"><i class="fas fa-info-circle">Data absensi masih kosong, silahkan input data kehadiran pada bulan dan tahun yang Anda pilih.</i></span>
    <?php } ?>
